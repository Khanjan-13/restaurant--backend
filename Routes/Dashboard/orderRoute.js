...
const { create, getAllOrders, getOrderById, saveOrderAndDeleteKot } = require("../../Controller/Dashboard/orderController.js");
...
router.post("/order-save/:tableNumber",authenticateUser, saveOrderAndDeleteKot);
